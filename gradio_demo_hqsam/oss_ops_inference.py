...
from segment_anything_hq import SamAutomaticMaskGenerator as SamAutomaticMaskGenerator_hq
...
def main_oss_ops_hqsam(**kwargs):
    ...
    generator = SamAutomaticMaskGenerator_hq(
        sam,
        points_per_side=args.points_per_side,
        points_per_batch=64,
        pred_iou_thresh=args.pred_iou_thresh,
